...
function pagecheckinquiryNowPage() {
    var txtPhone = document.getElementById("txtInquryContact").value;
    if (!req(document.getElementById("txtInquryName"), "Please Enter Your Name."))
        return false;
    if (!req(document.getElementById("txtInquryEmail"), "Please Enter Your Email ID."))
        return false;
    if (!isEmail(document.getElementById("txtInquryEmail"), "Please Enter Correct Email."))
        return false;
    if (!req(document.getElementById("txtInquryContact"), "Please Enter Your Phone."))
        return false;
    if (txtPhone.length < 10) {
        alert("Please enter minimum 10 digits mobile no.");
        return false;
    }
    if (!req(document.getElementById("txtInquryMessage"), "Please Enter Your Message."))
        return false;
}
...
function pagecheckCareer() {
    var txtPhone = document.getElementById("ContentPlaceHolder1_txtMobileCareer").value;
    ...
    if (!req(document.getElementById("ContentPlaceHolder1_txtEmailIdCareer"), "Please Enter Your Email ID."))
        return false;
    if (!isEmail(document.getElementById("ContentPlaceHolder1_txtEmailIdCareer"), "Please Enter Correct Email."))
        return false;
    if (!req(document.getElementById("ContentPlaceHolder1_txtMobileCareer"), "Please Enter Your Phone."))
        return false;
    if (txtPhone.length < 10) {
        alert("Please enter minimum 10 digits mobile no.");
        return false;
    }
    if (!chkValue(document.getElementById("ContentPlaceHolder1_DdCategory"), 0, "Select Job Name."))
        return false;
    if (!req(document.getElementById("ContentPlaceHolder1_UploadedCV_Career"), "Please upload you latest CV."))
        return false;
...
function validateFileUploadCareer(obj) {
    ...
    if (LengthOfFile > 3) {
        if (FileExtension1 == "docx" || FileExtension2 == "DOCX") {
            ...
            alert('Files with extension ".' + FileExtension1.toUpperCase() + '" are not allowed.nnYou can upload the files with following extensions only:\n.doc\n.docx\n.txt\n.pdf');
    ...
    var flagsize = false;
    var uploadedFile = document.getElementById('ContentPlaceHolder1_UploadedCV_Career');
    var fileSize = uploadedFile.files[0].size;
    if (fileSize > 1048576) flagsize = false;
    else flagsize = true;
    if (flag == false) {
        alert('Files with extension ".' + fileExtension.toUpperCase() + '" are not allowed.You can upload the files with following extensions only:\n.doc\n.docx\n.txt\n.pdf');
        document.getElementById("ContentPlaceHolder1_UploadedCV_Career").value = "";
        return false;
    } else if (flagsize == false) {
        fileSize = parseInt(fileSize / 1048576);
        alert('Uploaded photo size is more than ' + fileSize + 'MB.nnPlease upload less than 1MB photo size.n');
        document.getElementById("ContentPlaceHolder1_UploadedCV_Career").value = "";
        return false;
    } else {
        return true;
...
//6. User Signup for PAymnet
function pagecheckORderSignUp() {
    var txtPhone = document.getElementById("ContentPlaceHolder1_txtCustomerMobileNoForSignup").value;
    if (!req(document.getElementById("ContentPlaceHolder1_txtCustomerNameForSignup"), "Please Enter Your Name."))
        return false;
    if (!req(document.getElementById("ContentPlaceHolder1_txtCustomerEmailIDForSignup"), "Please Enter Your Email ID."))
        return false;
    if (!isEmail(document.getElementById("ContentPlaceHolder1_txtCustomerEmailIDForSignup"), "Please Enter Correct Email."))
        return false;
    if (!req(document.getElementById("ContentPlaceHolder1_txtCustomerMobileNoForSignup"), "Please Enter Your Phone."))
        return false;
    if (txtPhone.length < 10) {
        alert("Please enter minimum 10 digits mobile no.");
        return false;
    }
if (!req(document.getElementById("ContentPlaceHolder1_txtCustomerPincode"), "Please Enter Shipping Pincode."))
        return false;
    if (!req(document.getElementById("ContentPlaceHolder1_txtCustomerAddressForSignup"), "Please Enter Shipping Addresss."))
        return false;
    $("#UpdateProgress2").css("display", "block");
}     