...
function generate_wysiwyg(textareaID) {
  ...
  var toolbar2;
  toolbar2 = '<table cellpadding="0" cellspacing="0" border="0" class="toolbar2" style="width:' + toolbarWidth + 'px;"><tr>';
...
toolbar2 += '</tr></table>';  
  ...
  var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="background-color: #FFFFFF; width:' + wysiwygWidth + 'px; height:' + wysiwygHeight + 'px;border: 1px inset #CCCCCC;"><tr><td valign="top">\n'
...
function formatText(id, n, selected) {
  ...
  document.getElementById("wysiwyg" + n).contentWindow.focus();
	...
	if (viewTextMode == 1 && disabled_id == 1) {
      ...
      window.open(popupsDir + 'insert_image.aspx?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=400,height=250');
	  }
	    ...
	    window.open(popupsDir + 'insert_hyperlink.aspx?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=400,height=150');
	  }
...
function viewSource(n) {
  ...
  if (browserName == "Microsoft Internet Explorer") {
    ...
    getDocument.body.innerText = iHTML//.replace('https://www.lazyduke.com/GenesisIndia/Admin',"https://www.lazyduke.com/GenesisIndia/Admin");
	}
...
function viewText(n) { 
  ...
  if (browserName == "Microsoft Internet Explorer") {
    ...
    getDocument.body.innerHTML = iText//.replace('https://www.lazyduke.com/GenesisIndia/Admin',"https://www.lazyduke.com/GenesisIndia/Admin");
