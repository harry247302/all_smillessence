...
var gBegin=[2016,1,1];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
...
var gcCalBG="#000000";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="666666";	// the background color of the inner table, showing as a frame.
...
var gcCellBG="#383838";	// default background color of the cells. Use "" for transparent!!!
...
var gcWorkday="4da092";	// Workday font color
var gcSat="4da092";	// Saturday font color
var gcSatBG="383838";	// Saturday background color
var gcSun="white";	// Sunday font color
var gcSunBG="358275";	// Sunday background color
...
var gcToggle="black";	// the highlight color for the focused cell

var gcFGToday="red";	// the font color for today 
var gcBGToday="4f4f4f";	// the background color for today 
...
var gcBGSelected="white";	// the background color for the selected date
